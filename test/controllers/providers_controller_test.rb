...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference("Provider.count") do
      post providers_url, params: { provider: { contact_email: @provider.contact_email, name: @provider.name } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { contact_email: @provider.contact_email, name: @provider.name } }
